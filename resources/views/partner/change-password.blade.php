...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="p-6">
            ...
            @if(!auth('partner')->user()->password_changed)
                <div class="mb-4 rounded-md bg-red-50 border border-red-200 p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-red-800">Password Change Required</h3>
                            <p class="mt-1 text-sm text-red-700">
                                You are currently using a temporary password. For your account security, you must change it before accessing other features.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ route('partner.change-password.update') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input
                        ...
                        id="current_password"
                        required
                        class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('current_password') border-red-300 @enderror"
