...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action="{{ route('partner.login') }}" method="POST">
            @csrf
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                    <a href="{{ route('partner.password.request') }}" class="font-medium text-blue-600 hover:text-blue-500">
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    Don't have an account? <a href="{{ route('kyc.default') }}" class="font-medium text-blue-600 hover:text-blue-500">Complete KYC Form</a>
                </p>
            </div>
        </form>
    </div>
