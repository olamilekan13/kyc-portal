        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">
                            ₦{{ number_format(collect($transactions)->where('status', 'Completed')->sum('amount'), 2) }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500">Partnership Fee</p>
                        <p class="text-2xl font-bold text-gray-900">
                            ₦{{ number_format($finalOnboarding->partnership_model_price ?? 0, 2) }}
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            @foreach($transactions as $transaction)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ...
                                        <span class="text-xs text-gray-500">{{ $transaction['date']->format('h:i A') }}</span>
                                    </td>
